...
## Пример sync между двумя клиентами

1. Клиент A входит под пользователем.
2. Клиент B входит под тем же пользователем.
3. Клиент A создаёт или изменяет секрет.
4. Клиент B выполняет sync.
5. Клиент B получает изменения, произошедшие после последней синхронизации.
